...
const WORK = [
  {
    ...
    claim: "Project economics, regulatory sequencing, and financing structure have to move in the same direction. A project that works technically can still fail if the debt path closes before the offtake is signed — and that failure is usually irreversible.",
    evidence: "Before we price a round: signed demand commitments, a credible path to project debt, a deployment cadence that holds if one quarter slips, and the assumptions that break first if timelines move."
  },
  {
    ...
    evidence: "Before we price a round: field deployment reliability data, average implementation time and cost per customer, and evidence that sales has closed at least one cycle without founder force."
  },
  {
    sector: "Consumer",
    claim: "Growth can hide poor channel quality until the company is already committed to the wrong motion. The moment a founder steps back from the sales process is when unit economics get honest — and by then, the wrong channel structure is already baked in.",
    evidence: "Before we price a round: retention curves by acquisition channel, SKU-level contribution margins, cohort behavior in the second and third market, and what changed in channel mix when the founder was not closing deals."
  },
  {
    sector: "AI",
    ...
    evidence: "Before we price a round: account-level usage at six and twelve months, implementation depth and time-to-value per account, expansion logic, and the reason customers renew without founder involvement."
  },
];
...
const SITUATIONS = [
  {
    sector: "Consumer",
    description: "A company at ₹200 Cr in revenue was running sales and delivery on infrastructure designed for ₹50 Cr. The org had scaled headcount without scaling systems. The fix was rebuilding the commercial operations layer — not the product, not the team — before the next growth phase was accessible."
  },
  {
    sector: "Deeptech",
  ...
  {
    sector: "Energy Transition",
    description: "An infrastructure company entered commissioning with a capital structure built for one timeline and a deployment reality that required another. The gap between financial close and first revenue was longer than modelled. Managing that gap required a specific kind of investor involvement — not cheerleading, but working capital architecture."
  },
];
  ...
  return (
    <>
        ...
        <section className="port-hero">
          <div className="container">
            ...
            <h1 className="port-hero__title reveal reveal-delay-1">
              We describe what breaks, not what impresses.
            </h1>
            <p className="port-hero__desc reveal reveal-delay-2">
              Selective approach — not aggregating logos, reflecting specific timing and conviction. The companies we back have found their first market and are confronting the harder problem. Company details surface here as approvals are confirmed — we do not list companies before they have chosen to be public.
            </p>
          </div>
        </section>
      </RevealWrapper>
            ...
            <div className="port-conviction-grid">
              <div className="port-conviction__visuals">
                ...
                <div className="reveal reveal-delay-2">
                  <ImagePlaceholder label="Infrastructure Deployment Visual Placeholder" aspectRatio="16/9" />
                </div>
              </div>
      ...
      <RevealWrapper>
        <section className="port-list-section">
          <div className="container">
            ...
            <p className="port-list__intro reveal reveal-delay-1">
              Four sectors. One standard: the operating constraint has to be nameable before we price a round.
            </p>
            {WORK.map((item, i) => (
      ...
      <RevealWrapper>
        <section className="port-situations-section">
          <div className="container">
            ...
            <div className="port-situations-list">
              {SITUATIONS.map((situation, i) => (
                <div key={situation.sector} className={`port-situation reveal reveal-delay-${Math.min(i + 2, 5)}`}>
                  <span className="port-situation__tag">{situation.sector}</span>
                  <p className="port-situation__description">{situation.description}</p>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="port-support-modules">
              ...
              <div className="port-support-module reveal reveal-delay-4">
                ...
                <div className="port-support-module__body">
                  ...
                  <p className="port-support-module__desc">
                    Cash requirements of the growth plan, and the financing path the company is committing to. Not consulting deliverables — the things we know how to do because we have done them before, at our own cost.
                  </p>
                </div>
              </div>
            </div>
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .port-situation__description {
          font-size: var(--text-body);
          color: var(--color-steel);
          line-height: 1.7;
        }

        .port-situations__visual {
          max-width: 600px;
        }
